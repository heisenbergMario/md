...
proc init_gui { IPINST } {
  ...
  set_property tooltip {Width of S_AXI data bus} ${C_M00_AXI_DATA_WIDTH}
  set C_M00_AXI_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_M00_AXI_ADDR_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of S_AXI address bus} ${C_M00_AXI_ADDR_WIDTH}
  ipgui::add_param $IPINST -name "C_M00_AXI_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M00_AXI_HIGHADDR" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_M00_AXI_BASEADDR { PARAM_VALUE.C_M00_AXI_BASEADDR } {
	# Procedure called to update C_M00_AXI_BASEADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_AXI_BASEADDR { PARAM_VALUE.C_M00_AXI_BASEADDR } {
	# Procedure called to validate C_M00_AXI_BASEADDR
	return true
}

proc update_PARAM_VALUE.C_M00_AXI_HIGHADDR { PARAM_VALUE.C_M00_AXI_HIGHADDR } {
	# Procedure called to update C_M00_AXI_HIGHADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_AXI_HIGHADDR { PARAM_VALUE.C_M00_AXI_HIGHADDR } {
	# Procedure called to validate C_M00_AXI_HIGHADDR
	return true
}
