...
# Test: M00_AXI
# Create a write transaction at m00_axi_addr address
create_hw_axi_txn w_m00_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $m00_axi_addr -data $wdata_1
# Create a read transaction at m00_axi_addr address
create_hw_axi_txn r_m00_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $m00_axi_addr
...
if { $rdata_tmp == $wdata_1 } {
	...
	puts "Data comparison test fail for - M00_AXI, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
